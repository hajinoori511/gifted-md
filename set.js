...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~NDsXhDqQ#G60GXLks1tixlvnIA03KJdxqk44kns8zhkGrfUVR9JI", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "93784717965", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "93784727965", // Only 1 owner Number Here, others Add to sudo numbers...
...
TIME_ZONE: process.env.TIME_ZONE || "Afghanistan/jawzjan", // Enter yours else leave blank if not sure
};
